...
using .flxMLMM: geneScan,gene1Scan,gene2Scan,envScan,permTest,K2eig, K2Eig,getKc,transZ!,transPD, transForm
#selectQTL
export geneScan,gene2Scan,envScan,permTest,K2eig, K2Eig, gene1Scan,getKc,transZ!,transPD, transForm
